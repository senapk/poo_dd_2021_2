...
class Motinha {
    ...
    /// como no constructor inicializamos pessoa como null, ao retornar no tostring "pessoa" o terminal aponta um
    /// possivel erro de acessar o nome de uma pesssoa que pode ser que também estaja vazio 
    toString(): string{
        if (this.pessoa != null)
