...
// quadrado, onde o valor de x é inicialmente 0 e enquanto x for menor que o valor de nc continua desenhado quadrinho na vertical
...
function setup() {
 ...
 // e que aqui seria usado com esse proposito ?  
  ...
  createCanvas(oceano.nc*size*2,oceano.nc*size*/2);
