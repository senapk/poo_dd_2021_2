...
class Bichodomar {
  ...
  draw(): void {
    image(this.tub_img, this.x*this.nado, this.y*this.nado, this.nado,this.nado/2);/// posição de x,y,largura e altura, aqui como preciso que o peixe seja menor que o tubarão divid
  }
}
