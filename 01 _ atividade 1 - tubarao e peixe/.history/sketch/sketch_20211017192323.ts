...
function setup() {
  //// A função setup () é chamada uma vez quando o
   programa é iniciado. É usado para definir propriedades
    ...
    fundo, e para carregar mídia, como imagens e fontes, conforme o programa é iniciado. Só pode haver uma função setup () para cada programa e ela não deve ser chamada novamente após sua execução inicial.
