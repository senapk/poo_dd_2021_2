...
//aqui se faz um for para que a partir de um quadrado que não tem preenchimento, esse quadrado seja repetido  onde o valor de x é inicialmente 0 e se  x for menor que o valor de nc continua desenhado quadrinho na vertical até parar 
