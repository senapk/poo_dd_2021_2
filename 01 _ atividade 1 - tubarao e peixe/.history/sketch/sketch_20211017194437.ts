...
class Bichodomar {
  ...
  /// CONSTRUCTOR 
  /// ao que entendi o constructor é  que é importante para instanciar a classe e 
  /// fazer sugir o objeto, que é criado la na função setup(), usando o new"como os atributos definidos anteriormente na classe
  ///  
