...
/// um tamanho definido como nado, e um background do tipo p5.image. bichos do oceano, tendo como atributos um valor de x e y, um tamanho que apartir desse valor
// definirá a posição e movimento do animal (que no caso coloquei como "nado") e dentro dessa classe tem também
// uma imagem que é do tipo.p5
