...
/// que se faz um for para que a partir seja depois criado um quadrado que não tem preenchimento, e vou repetir esse
// quadrado, onde o valor de x é inicialmente 0 e se  x for menor que o valor de nc continua desenhado quadrinho na vertical até parar 
// que é algo que acho  que tem a ver com o tamanho da tela definido em createcanvas
...
function setup() {
 ...
 // e que aqui seria usado com esse proposito ?  
  ...
  createCanvas(oceano.nc*size*2,oceano.nc*size);
 //  o create canvas Cria um elemento de tela no documento e define suas dimensões em pixels. 
