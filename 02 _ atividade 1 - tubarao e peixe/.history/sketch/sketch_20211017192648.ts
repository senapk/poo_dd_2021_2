...
/// PRELOAD()
//Chamada diretamente antes de setup () , a função preload () é usada para lidar com o carregamento assíncrono de arquivos externos de forma bloqueadora. Se uma função de pré-carregamento for definida, setup () irá esperar até que qualquer chamada de carregamento dentro tenha terminado. 
function preload(){
