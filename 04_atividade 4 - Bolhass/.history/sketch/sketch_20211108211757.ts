...
class Mesadejogo {
  bolhas: Bolha [] = [];
  constructor() {
    this.bolhas = [ new Bolha (100,100,"c",1)];
    this.bolhas.push(new Bolha(150,100,"a",3));
    this.bolhas.push(new Bolha(200,100,"n",2));
    this.bolhas.push(new Bolha(250,100,"s",4));
    this.bolhas.push(new Bolha (300,100,"a",1));
    this.bolhas.push(new Bolha(350,100,"d",3));
    this.bolhas.push(new Bolha(400,100,"a",2));
    this.bolhas.push(new Bolha(450,100,"n",4));
  }
