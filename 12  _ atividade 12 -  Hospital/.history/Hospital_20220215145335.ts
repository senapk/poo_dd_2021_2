...
let paciente1 = new Paciente("doença1", "pessoa1");
let paciente2 = new Paciente("cdoença2", "pessoa2");
let paciente3 = new Paciente("doneça3", "pessoa3");
...
h.pacientes.get("pessoa1").adicionarMedico(medico1);
h.pacientes.get("pessoa1").adicionarMedico(medico1); // emite erro pois o medico1 ja existe
