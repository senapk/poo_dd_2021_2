...
function draw(){
  ...
  // e aqui o draw do jogo, ja que o update ficou la em cima e dentro do draw então a classe bolha fica sendo executada dentro da classe mesa de jogo, e a mesa de jogo dentro de jogo 
  jogo.draw();
