...
class Mesadejogo {
  ...
  constructor() {
    ...
    this.bolhas.push(new Bolha(200,100,"a",3));
    this.bolhas.push(new Bolha(300,100,"n",2));
    this.bolhas.push(new Bolha(400,100,"s",4));
    this.bolhas = [ new Bolha (500,100,"a",1)];
    this.bolhas.push(new Bolha(200,100,"d",3));
    this.bolhas.push(new Bolha(300,100,"a",2));
    this.bolhas.push(new Bolha(400,100,"n",4));
  }
