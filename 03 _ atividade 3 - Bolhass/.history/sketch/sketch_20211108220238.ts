...
class Jogo {
  ...
  /// apaga o update aqui e coloca dentro do draw, depois renomeamos draw para jog
  draw(): void {
    background(100)
...
/// let bolha1:Bolha; substitui por let mesadejogo: Mesadejogo que agora substitui por:
...
function draw(){
  ...
  // e aqui o draw e update de jogo, então a classe bolha fica sendo executada dentro da classe mesa de jogo, e a mesa de jogo dentro de jogo 
  jogo.draw();
